...
std::vector<Robot> InverseKinematics::sample_all_goals(std::vector<Robot> &answers, Robot pos, const GoalPoint &goal, const std::vector<Polygon> &obstacles, const double from, const double to, const double step)
{
    /*
